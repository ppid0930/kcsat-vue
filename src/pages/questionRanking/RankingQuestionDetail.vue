  ...
  <div>
    <div class="container">
      ...
      <div class="form-group font-roman">
        <p class="text-xl-left font-nanum-gothic-regular">{{ data.type }}</p>
      ...
      <div class="container">
        ...
        <button v-else type="button" class="btn btn-primary btn-sm mx-1" @click="saveQuestion()">문제 저장하기</button>
      ...
      <div class="form-group" v-show="showAnswer">
        ...
        <p class="text-xl-left font-nanum-gothic-regular"><span class="font-nanum-myeongjo-extrabold">번역 : </span>{{ data.translation }}</p>
        <p class="text-xl-left font-nanum-gothic-regular"><span class="font-nanum-myeongjo-extrabold">해설 : </span>{{ data.explanation }}</p>
      </div>
